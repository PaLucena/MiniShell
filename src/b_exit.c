...
/*   Updated: 2023/11/09 19:21:09 by rdelicad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	exit_number(t_info *i)
{
	...
	num = 0;
	if (ft_atol(i->par->args[0]) > INT_MAX || ft_atol(i->par->args[0]) < INT_MIN)
		exit_no_digit(i);
	else if (ft_atoi(i->par->args[0]) < -255 || ft_atoi(i->par->args[0]) > 255)
	{
